...
// This file owns the HTTP layer for the escrow module:
//   - URL paths and HTTP methods
//   - Which routes are public vs authenticated (preHandler per route)
//   - Per-route rate limits tuned to the sensitivity of each operation
//
// Financial operations (create, transition, dispute) get stricter limits.
// Read operations get generous limits. Public routes get the most.
